...
const Room3Products: React.FC = () => {
    ...
    return (
        <div className={`relative w-full ${isMobile ? 'h-auto py-20' : 'h-full flex flex-col items-center justify-center'} bg-[#000512] overflow-hidden p-6 sm:p-12`}>
            <motion.div
                initial={{ opacity: 0, y: -20 }}
                whileInView={{ opacity: 1, y: 0 }}
                className="text-center mb-8 sm:mb-16"
            >
                <h2 className="text-4xl sm:text-5xl md:text-7xl font-black uppercase tracking-tighter">The Collections</h2>
            ...
            {isMobile ? (
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 w-full">
                    {products.map((product) => (
                        <motion.div
                            ...
                            className="bg-white/5 backdrop-blur-3xl rounded-2xl border border-white/10 p-6 flex flex-col items-center gap-4"
                        >
                            <img
                            ...
                            <div className="text-center w-full">
                                <p className="text-[8px] font-black uppercase tracking-widest text-blue-500 mb-1">{product.category}</p>
                                <h3 className="text-lg font-black uppercase tracking-tight truncate">{product.name}</h3>
                                <button className="mt-4 w-full py-3 bg-white text-black text-[10px] font-black uppercase tracking-widest rounded-lg">
                                    Explore Scent
                                </button>
                            </div>
                        </motion.div>
                ...
                /* 3D Carousel Surface - Desktop Only */
                <>
