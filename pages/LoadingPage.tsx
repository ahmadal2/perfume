          ...
          <div className="mt-16 text-center relative h-32 w-screen px-4">
            <AnimatePresence mode="wait">
              {stage < 3 ? (
                ...
                >
                  <h1 className="text-7xl md:text-[9rem] font-black tracking-[0.3em] text-transparent bg-clip-text bg-gradient-to-r from-amber-100 via-amber-400 to-amber-100 uppercase serif italic text-glow leading-none">
                    KHAMRAH
                  </h1>
                  <div className="flex items-center gap-8 mt-10 opacity-50">
                    <div className="h-px w-24 bg-amber-500/40" />
                    <span className="text-[12px] uppercase tracking-[0.8em] text-amber-400 font-black whitespace-nowrap">The Essence of Amber</span>
                    <div className="h-px w-24 bg-amber-500/40" />
                  </div>
                </motion.div>
              ) : (
                ...
                >
                  <h1 className="text-7xl md:text-[9rem] font-black tracking-[0.3em] text-transparent bg-clip-text bg-gradient-to-r from-red-600 via-orange-400 to-amber-600 uppercase serif italic text-glow leading-none">
                    FEVER
                  </h1>
                  <div className="flex items-center gap-8 mt-10 animate-pulse">
                    <div className="h-px w-24 bg-red-600/60" />
                    <span className="text-[12px] uppercase tracking-[0.8em] text-orange-500 font-black whitespace-nowrap">Distilled In Paris</span>
                    <div className="h-px w-24 bg-red-600/60" />
                  </div>
                </motion.div>
              )}
